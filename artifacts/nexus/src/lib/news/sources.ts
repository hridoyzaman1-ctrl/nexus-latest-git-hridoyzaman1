...
export const NEWS_SOURCES: NewsSource[] = [
  ...
  {
    name: 'The Business Standard BD Business',
    feedUrl: 'https://www.tbsnews.net/feed',
    mode: 'national',
    category: 'business',
    language: 'en',
    region: 'bangladesh',
  ...
  {
    name: 'The Financial Express BD Business',
    feedUrl: 'https://thefinancialexpress.com.bd/feed',
    mode: 'national',
    category: 'business',
    language: 'en',
    region: 'bangladesh',
